...
import com.nefi.mateus.dao.ClienteDAO;
...
public class ClientesListaController implements Initializable {
	...
	void onClickBtnEditar(ActionEvent event) {
		...
		if (cliente != null) {
			boolean btnConfirmarClic = this.onShowTelaClienteEditar(cliente, ClientesListaController.CLIENTE_EDITAR);
	...
	void onClickBtnIncluir(ActionEvent event) {
		...
		boolean btnConfirmarClick = this.onShowTelaClienteEditar(cliente, ClientesListaController.CLIENTE_INCLUIR);
	...
	public void selecionarItemTableViewClientes(Cliente cliente) {
		if (cliente != null) {
			...
			this.lblCpfValor.setText(cliente.getCpf());
	...
	public boolean onShowTelaClienteEditar(Cliente cliente, String operacao) {
		try {
			// carregando o loader
			FXMLLoader loader = new FXMLLoader(getClass().getResource("/com/nefi/mateus/view/ClientesEdit.fxml"));
