...
import com.nefi.mateus.dao.FilmeDAO;
...
public class FilmesListaController implements Initializable {
    ...
    @FXML
    private Label lblProdutoraValor;
	...
	void onClickBtnEditar(ActionEvent event) {
		...
		if (filme != null) {
			boolean btnConfirmarClick = this.onShowTelaFilmeEditar(filme,
					FilmesListaController.FILME_EDITAR);
	...
	void onClickBtnIncluir(ActionEvent event) {
		...
		boolean btnConfirmarClick = this.onShowTelaFilmeEditar(filme,
				FilmesListaController.FILME_INCLUIR);
	...
	public void selecionarItemTableViewFilmes(Filme filme) {
		if (filme != null) {
			...
			this.lblProdutoraValor.setText(filme.getProdutora());
			this.lblLancamentoValor.setText(filme.getLancamentoFormatado());
		} else {
			this.lblNomeValor.setText("");
			this.lblProdutoraValor.setText("");
			this.lblLancamentoValor.setText("");
		}
	}
	...
	public boolean onShowTelaFilmeEditar(Filme filme, String operacao) {
		try {
			// carregando o loader
			FXMLLoader loader = new FXMLLoader(getClass().getResource("/com/nefi/mateus/view/FilmesEdit.fxml"));
			...
			FilmesEditController filmeEditController = loader.getController();
